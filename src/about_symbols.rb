...
class AboutSymbols < Neo::Koan
  ...
  #
  # ANSWER: Check including symbol will always true, even if the method name
  ...
  #
  # ANSWER: In Ruby versions below 2.2, Symbols are not garbage collected.
  # So creating a lot of symbols uses a lot of memory.
end
