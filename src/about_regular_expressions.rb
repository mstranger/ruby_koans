...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    #
    # ANSWER: "*" will always match an empty string.
  end
  ...
  # Why?
  #
  # ANSWER:  Because repetition operator matches as much as possible.
  ...
  #
  # ANSWER: The character class allows for a range of characters.
  # Alternations can specify only a sequence of characters.
  # For example: /[a-z]+/ and /(one|two)/
